...
export const TokensApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        registriesTokensGet: async (registryId: string, offset?: string, limit?: string,  maxResults?: number, filters?: Map<string, string>, options: any = {}): Promise<RequestArgs> => {
            if (registryId === null || registryId === undefined) {
...
export const TokensApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async registriesTokensGet(registryId: string, offset?: string, limit?: string, maxResults?: number, filters?: Map<string, string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TokensResponse>> {
            const axiosArgs = await TokensApiAxiosParamCreator(configuration).registriesTokensGet(registryId, offset, limit, maxResults, filters, options);
            return runRequest(axiosArgs, configuration);
        },
        /**
         * Update token properties, for example: - change status to \'enabled\' or \'disabled\' - change expiry date
...
export class TokensApi extends BaseAPI {
    ...
    public registriesTokensGet(requestParameters: TokensApiRegistriesTokensGetRequest, options?: any) {
        return TokensApiFp(this.configuration).registriesTokensGet(requestParameters.registryId, requestParameters.offset, requestParameters.limit, requestParameters.maxResults, requestParameters.filters, options).then((request) => request(this.axios, this.basePath));
    }
