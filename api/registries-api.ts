...
export const RegistriesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        registriesGet: async (filterName?: string, limit?: string, paginationToken?: string,  orderBy?: string, maxResults?: number, filters?: Map<string, string>, options: any = {}): Promise<RequestArgs> => {
...
export const RegistriesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async registriesGet(filterName?: string, limit?: string, paginationToken?: string, orderBy?: string, maxResults?: number, filters?: Map<string, string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RegistriesResponse>> {
            const axiosArgs = await RegistriesApiAxiosParamCreator(configuration).registriesGet(filterName, limit, paginationToken, orderBy, maxResults, filters, options);
            return runRequest(axiosArgs, configuration);
        },
        /**
         * Update the properties of a registry - \"garbageCollectionSchedule\" time and days of the week for runs
...
export class RegistriesApi extends BaseAPI {
    ...
    public registriesGet(requestParameters: RegistriesApiRegistriesGetRequest = {}, options?: any) {
        return RegistriesApiFp(this.configuration).registriesGet(requestParameters.filterName, requestParameters.limit, requestParameters.paginationToken, requestParameters.orderBy, requestParameters.maxResults, requestParameters.filters, options).then((request) => request(this.axios, this.basePath));
    }
